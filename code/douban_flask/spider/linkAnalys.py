...
import collections
stop_path="C:/Users/XC/Desktop/stopwords.txt"
class LinkAnls():
    ...
    def getData(self):
        ...
        self.getIntro(soup)
        self.getComment()
        self.allinfo={'up':self.video_upname,'like':self.like,'name':self.video_name,'img':self.video_img,'tag':self.video_Tags,'time':self.video_Time,'coin':self.coin,'trans':self.trans,'intro':self.Intro,'collect':self.collect}
